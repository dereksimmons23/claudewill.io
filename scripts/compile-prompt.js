...
module.exports = { SYSTEM_PROMPT: ${JSON.stringify(SYSTEM_PROMPT)}, VERNIE_PROMPT: ${JSON.stringify(VERNIE_PROMPT)} };
`;

fs.writeFileSync(outFile, output, 'utf8');
console.log(`Compiled prompts: standard=${SYSTEM_PROMPT.length} chars, vernie=${VERNIE_PROMPT.length} chars → ${outFile}`);
