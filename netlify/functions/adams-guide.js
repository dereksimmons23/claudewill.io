...
2. The Audience Is Moving — print/analog/live/local trend, backed by specific data points: Substack paid subscribers grew from 2M (2023) to 5M+ (March 2025, per Tubefilter); The Atlantic crossed 1M subscribers in 2024 and expanded its print magazine (CNN, October 2024); US independent bookstores up 70% since 2020 (American Booksellers Association 2024-25 annual report); worker-owned Defector reports ~40K paid subscribers and $4.6M revenue in their annual report. The slide explicitly acknowledges this is NOT a universal trend — print circulation overall is still declining — but specific segments returning to physical, named, and local are growing. Closes with Mark Adams's own July 2025 rebrand quote: "we continue to fund that future with a focus on print." If asked about sources, cite these directly.
