...
- **The Kitchen** — Public narrative page at /kitchen. "How one person runs a consulting practice with AI." Vertical scroll: "While you slept" overnight report, the crew (four lenses), the board (active projects), the stack (tools + costs), the method. Reads from kitchen-data.json (generated by overnight agents via GitHub Actions at 5 AM CST). Dark theme, terminal aesthetic. CTA: "What took 14 months to learn takes a few hours to teach." → /work-with-me.
...
├── workshop.html           # /workshop — DEAD, redirects to /kitchen
├── library.html            # /library — DEAD, redirects to /derek
├── map.html                # /map — DEAD, redirects to /
...
**Deleted pages:** proof.html, strategies.html, mirae.html (folded into /derek), the-cw-standard.html (content at /story#the-cw-standard). studio.html renamed to workshop.html. All have 301 redirects in netlify.toml. **Dead pages (Feb 24):** library→derek, map→/, workshop→kitchen, derek/assessment→work-with-me, stable/studio→kitchen.
...
**Redirects (301):** /strategies → /derek, /proof → /derek, /mirae → /, /stable → /kitchen, /studio → /kitchen, /workshop → /kitchen, /the-cw-standard → /story, /library → /derek, /map → /, /derek/assessment → /work-with-me, /intake → /work-with-me
