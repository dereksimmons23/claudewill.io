...
| Reclaiming Connection | LinkedIn | drafts/linkedin/Reclaiming connection in an all-digital age.md | |
| Launch Day — HN | Hacker News | drafts/linkedin/launch-day-hn.md | |
| Launch Day — Reddit | Reddit | drafts/linkedin/launch-day-reddit.md | |
| Launch Day — Product Hunt | Product Hunt | drafts/linkedin/launch-day-producthunt.md | |
...
1. Write or pull from existing drafts in `docs/drafts/`
2. Copy TEMPLATE.md → new file, fill in metadata + links + body
3. Paste into platform editor, add image, post
4. Move file to `docs/published/[platform]/`
5. Update this tracker
6. Commit the published file

---

## Notes

- 200K+ words already written across the ecosystem (master audit in docs/reference/)
- 5 Dawn content pulls identified (see drafts/linkedin/linkedin-content-pulls.md)
- LinkedIn company slug is `/cw-stategies` (typo) — fixable early March 2026
- LinkedIn at ~126 followers — 150 unlocks newsletter feature
